...
return [
    'ctrl' => [
        ...
        'searchFields' => 'title',
        'iconfile' => 'EXT:fbgproject/Resources/Public/Icons/degreecourse.png'
    ],
    'interface' => [
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_fbgproject_domain_model_degreecourse}.{#pid}=###CURRENT_PID### AND {#tx_fbgproject_domain_model_degreecourse}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
