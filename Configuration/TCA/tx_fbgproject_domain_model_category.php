...
return [
    'ctrl' => [
        ...
        'searchFields' => 'title',
        'iconfile' => 'EXT:fbgproject/Resources/Public/Icons/category.png'
    ],
    'interface' => [
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_fbgproject_domain_model_category}.{#pid}=###CURRENT_PID### AND {#tx_fbgproject_domain_model_category}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
